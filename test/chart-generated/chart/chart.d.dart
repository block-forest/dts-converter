...
@JS()
class ChartOptions {
  external factory ChartOptions /* extends ChartSettings */ (
  ...
  external bool get scaleShowHorizontalLines;
  external set scaleShowHorizontalLines(bool v);
  external bool get scaleShowVerticalLines;
  external set scaleShowVerticalLines(bool v);
...
class CircularInstance {
  external factory CircularInstance /* extends ChartInstance */ (
      {List<CircularChartData> segments});
...
class LineChartOptions {
  external factory LineChartOptions /* extends ChartOptions */ (
      {bool bezierCurve,
...
class BarChartOptions {
  external factory BarChartOptions /* extends ChartOptions */ (
      {bool scaleBeginAtZero,
      bool barShowStroke,
      num barStrokeWidth,
      num barValueSpacing,
...
class RadarChartOptions {
  external factory RadarChartOptions /* extends ChartSettings */ (
      {bool scaleShowLine,
...
class PolarAreaChartOptions {
  external factory PolarAreaChartOptions /* extends ChartSettings */ (
...
class PieChartOptions {
  external factory PieChartOptions /* extends ChartSettings */ (
      {bool segmentShowStroke,
      String segmentStrokeColor,
      num segmentStrokeWidth,
...
class Chart {
  ...
  external LinearInstance Line(LinearChartData data, LineChartOptions options);
  ...
  external CircularInstance Pie(
      List<CircularChartData> data, PieChartOptions options);
  external CircularInstance Doughnut(
      List<CircularChartData> data, PieChartOptions options);
}
