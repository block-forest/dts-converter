...
class AnimationAction   {
	external factory AnimationAction ([ AnimationClip clip, num startTime, num timeScale, num weight, bool loop ]);
		...
		external set propertyBindings(List<PropertyBinding> v);external 

         AnimationAction setLocalRoot( Mesh localRoot );external 
         num updateTime( num clipDeltaTime );external 
         AnimationAction syncWith( AnimationAction action );external 
         AnimationAction warpToDuration( num duration );external 
         AnimationAction init( num time );external 
         List<dynamic> update( num clipDeltaTime );external 
         num getTimeScaleAt( num time );external 
         num getWeightAt( num time );
...
class AnimationClip   {
	external factory AnimationClip ([  String name, num duration, List<KeyframeTrack>  tracks ]);
		...
		external set results(List<dynamic> v);external 

         List<dynamic> getAt(num clipTime );external 
         AnimationClip trim();external 
         AnimationClip optimize();

         external static AnimationClip CreateFromMorphTargetSequence( String name , List<MorphTarget> morphTargetSequence , num fps );external 
         AnimationClip findByName( AnimationClip clipArray , String name );
         external static List<AnimationClip> CreateClipsFromMorphTargetSequences( List<MorphTarget> morphTargets , num fps );external 
         AnimationClip parse( dynamic json );external 
         AnimationClip parseAnimation( dynamic animation , List<Bone> bones , String nodeName );
...
class AnimationMixer   {
	external factory AnimationMixer ([  dynamic  root ]);
		...
		external set propertyBindingMap(dynamic v);external 

         void addAction( AnimationAction action );external 
         AnimationMixer removeAllActions();external 
         AnimationMixer removeAction( AnimationAction action );external 
         AnimationAction findActionByName( String name );external 
         AnimationMixer play( AnimationAction action , num optionalFadeInDuration );external 
         AnimationMixer fadeOut( AnimationAction action , num duration );external 
         AnimationMixer fadeIn( AnimationAction action , num duration );external 
         AnimationMixer warp( AnimationAction action , NumberKeyframeTrack startTimeScale , NumberKeyframeTrack endTimeScale , num duration );external 
         AnimationMixer crossFade( AnimationAction fadeOutAction , AnimationAction fadeInAction , num duration , bool warp );external 
...
class AnimationUtils    {
	external factory AnimationUtils();
		...
		external bool getEqualsFunc( dynamic exemplarValue );external 
         dynamic clone(Object3D exemplarValue );external 
         dynamic lerp( dynamic a , dynamic b , num alpha , bool interTrack );external 
         dynamic lerp_object( dynamic a , dynamic b , num alpha );external 
         dynamic slerp_object( dynamic a , dynamic b , num alpha );external 
         dynamic lerp_num( dynamic a , dynamic b , num alpha );external 
         dynamic lerp_bool( dynamic a , dynamic b , num alpha );external 
         dynamic lerp_bool_immediate( dynamic a , dynamic b , num alpha );external 
         dynamic lerp_String( dynamic a , dynamic b , num alpha );external 
         dynamic lerp_String_immediate( dynamic a , dynamic b , num alpha );external 
         Function getLerpFunc( dynamic exemplarValue , bool interTrack );
...
class KeyframeTrack   {
	external factory KeyframeTrack ([ String name, List<dynamic> keys ]);
		...
		external set lastIndex(num v);external 

         dynamic getAt( num time );external 
         KeyframeTrack shift( num timeOffset );external 
         KeyframeTrack scale( num timeScale );external 
         KeyframeTrack trim( num startTime , num endTime );external 
         KeyframeTrack validate();external 
         KeyframeTrack optimize();external 

         num keyComparator(KeyframeTrack key0 , KeyframeTrack key1 );external 
         KeyframeTrack parse( dynamic json );external 
         dynamic GetTrackTypeForTypeName( String typeName );
...
class PropertyBinding   {
	external factory PropertyBinding ([  dynamic rootNode, String  trackName ]);
		...
		external set cumulativeWeight(num v);external 

         void reset();external 
         void accumulate( dynamic value , num weight );external 
         void unbind();external 
         void bind();external 
         void apply();external 
         dynamic parseTrackName( String trackName );external 
         dynamic findNode( dynamic root , String nodeName );
...
class BooleanKeyframeTrack  extends KeyframeTrack  {
	external factory BooleanKeyframeTrack ([ String name, List<dynamic> keys ]);
		...
		external set result(dynamic v);external 

         void setResult( dynamic value );external 
         dynamic lerpValues( dynamic value0 , dynamic value1 , num alpha );external 
         bool compareValues( dynamic value0 , dynamic value1 );external 
         BooleanKeyframeTrack clone();external 
         BooleanKeyframeTrack parse( dynamic json );
...
class NumberKeyframeTrack   {
	external factory NumberKeyframeTrack ();
		...
		external set result(dynamic v);external 
         ...
         dynamic lerpValues( dynamic value0 , dynamic value1 , num alpha );external 
         bool compareValues( dynamic value0 , dynamic value1 );external 
         NumberKeyframeTrack clone();external 
         NumberKeyframeTrack parse( dynamic json );
...
class QuaternionKeyframeTrack   {
	external factory QuaternionKeyframeTrack ();
		...
		external set result(dynamic v);external 
         ...
         dynamic lerpValues( dynamic value0 , dynamic value1 , num alpha );external 
         bool compareValues( dynamic value0 , dynamic value1 );external 
         QuaternionKeyframeTrack clone();external 
         QuaternionKeyframeTrack parse( dynamic json );
...
class StringKeyframeTrack   {
	external factory StringKeyframeTrack ();
		...
		external set result(dynamic v);external 
         ...
         dynamic lerpValues( dynamic value0 , dynamic value1 , num alpha );external 
         bool compareValues( dynamic value0 , dynamic value1 );external 
         StringKeyframeTrack clone();external 
         StringKeyframeTrack parse( dynamic json );
...
class VectorKeyframeTrack   {
	external factory VectorKeyframeTrack ();
		...
		external set result(dynamic v);external 
         ...
         dynamic lerpValues( dynamic value0 , dynamic value1 , num alpha );external 
         bool compareValues( dynamic value0 , dynamic value1 );external 
         VectorKeyframeTrack clone();external 
         VectorKeyframeTrack parse( dynamic json );
...
class Camera  extends Object3D  {
	external factory Camera ();
		...
		external set projectionMatrix(Matrix4 v);external 

         Vector3 getWorldDirection(Vector3 optionalTarget );external 

        
         void lookAt(Vector3 vector );external 

         Camera clone();external 
...
class CubeCamera  extends Object3D  {
	external factory CubeCamera ([  num near, num far, num cubeResolution ]);
		...
		external set renderTarget(WebGLRenderTargetCube v);external 

         void updateCubeMap( Renderer renderer , Scene scene );
...
class OrthographicCamera  extends Camera  {
	external factory OrthographicCamera ([ num left, num right, num top, num bottom, num near, num far ]);
		...
		external set far(num v);external 

        
         void updateProjectionMatrix();external 
         OrthographicCamera clone();external 
         OrthographicCamera copy( OrthographicCamera source );external 
         dynamic toJSON( dynamic meta );
...
class PerspectiveCamera  extends Camera  {
	external factory PerspectiveCamera ([ num fov, num aspect, num near, num far ]);
		...
		external set far(num v);external 
         ...
         void setLens(num focalLength , num frameHeight );external 

        
         void setViewOffset(num fullWidth , num fullHeight , num x , num y , num width , num height );external 

        
         void updateProjectionMatrix();external 
         PerspectiveCamera clone();external 
         PerspectiveCamera copy( PerspectiveCamera source );external 
         dynamic toJSON( dynamic meta );
...
/*         updateRange #num offset , count:num# ; */
		...
		external set count(num v);external 

         BufferAttribute setDynamic(bool dynamic );external 
         BufferAttribute copy(BufferAttribute source );external 
         BufferAttribute copyAt(num index1 , BufferAttribute attribute , num index2 );external 
         BufferAttribute copyArray(List<num> array );
/*         copyColorsArray(colors #num r , num g , b:num# []): BufferAttribute; */
/*         copyIndicesArray(indices #num a , num b , c:num# []): BufferAttribute; */
/*         copyVector2sArray(vectors #num x , y:num# []): BufferAttribute; */
/*         copyVector3sArray(vectors #num x , num y , z:num# []): BufferAttribute; */
/*         copyVector4sArray(vectors #num x , num y , num z , w:num# []): BufferAttribute; */external 
         BufferAttribute set(List<num> value , num offset );external 
         num getX(num index );external 
         BufferAttribute setX(num index , num x );external 
         num getY(num index );external 
         BufferAttribute setY(num index , num y );external 
         num getZ(num index );external 
         BufferAttribute setZ(num index , num z );external 
         num getW(num index );external 
         BufferAttribute setW(num index , num z );external 
         BufferAttribute setXY(num index , num x , num y );external 
         BufferAttribute setXYZ(num index , num x , num y , num z );external 
         BufferAttribute setXYZW(num index , num x , num y , num z , num w );
...
/*         drawRange # num start , count: num # ; */
        ...
        /** Deprecated. */external 
         void addIndex( BufferAttribute index );external 

         BufferAttribute getIndex();external 
         void setIndex( BufferAttribute index );

        /** Deprecated. This overloaded method is deprecated. */external 
          
         void addAttribute(String name , dynamic attribute );external 
         dynamic  getAttribute(String name );external 
        ...
        /** Deprecated. Use addGroup */external 
         void addDrawCall(num start , num count , num index );
        /** Deprecated. */external 
         void clearDrawCalls();external 
         void addGroup(num start , num count , num materialIndex );external 
         void clearGroups();external 

         void setDrawRange(num start , num count );external 

        
         void applyMatrix(Matrix4 matrix );external 

         BufferGeometry rotateX(num angle );external 
         BufferGeometry rotateY(num angle );external 
         BufferGeometry rotateZ(num angle );external 
         BufferGeometry translate(num x , num y , num z );external 
         BufferGeometry scale(num x , num y , num z );external 
         void lookAt(Vector3 v );external 

         Vector3 center();external 

         void setFromObject(Object3D object );external 
         void updateFromObject(Object3D object );external 

         BufferGeometry fromGeometry(Geometry geometry , dynamic settings );external 

         BufferGeometry fromDirectGeometry( DirectGeometry geometry );external 

        
         void computeBoundingBox();external 

        
         void computeBoundingSphere();external 

        
         void computeFaceNormals();external 

        
         void computeVertexNormals();external 

         void computeOffsets(num size );external 
         BufferGeometry merge(BufferGeometry geometry , num offset );external 
         void normalizeNormals();external 
         dynamic toJSON();external 
         BufferGeometry clone();external 
         BufferGeometry copy(BufferGeometry source );external 

        
         void dispose();external 


        
         void addEventListener(String type , VoidFunc1<dynamic> listener );external 
         void hasEventListener(String type , VoidFunc1<dynamic> listener);external 
         void removeEventListener(String type , VoidFunc1<dynamic> listener);
/*         dispatchEvent(event # type: String; target: dynamic; # ): void; */
...
class Channels   {
	external factory Channels ();
		...
		external set mask(num v);external 

         void set( num channel );external 
         void enable( num channel );external 
         void toggle( num channel );external 
         void disable( num channel );
...
class Clock   {
	external factory Clock ([ bool autoStart ]);
		...
		external set running(bool v);external 
...
/*         groups #num start , materialIndex: num# []; */
		...
		external set groupsNeedUpdate(bool v);external 

         void computeBoundingBox();external 
         void computeBoundingSphere();external 
         void computeGroups(Geometry geometry );external 
         DirectGeometry fromGeometry(Geometry geometry );external 
         void dispose();external 
...
class EventDispatcher   {
	external factory EventDispatcher ();
		...
		external void addEventListener(String type , VoidFunc1<dynamic> listener );external 
...
class Face3   {
	external factory Face3 ([ num a, num b, num c, List<Vector3> vertexNormals, List<Color> vertexColors, num materialIndex ]);
		...
		external set materialIndex(num v);external 
...
class Geometry   {
	external factory Geometry ();
		...
		external set groupsNeedUpdate(bool v);external 
         ...
         Geometry rotateX(num angle );external 
         Geometry rotateY(num angle );external 
         Geometry rotateZ(num angle );external 

         Geometry translate(num x , num y , num z );external 
         Geometry scale(num x , num y , num z );external 
         void lookAt( Vector3 vector );external 


         Geometry fromBufferGeometry(BufferGeometry geometry );external 

        
         Vector3 center();external 

         Geometry normalize();external 

        
         void computeFaceNormals();

         external 
         void computeVertexNormals(bool areaWeighted );external 

        
         void computeMorphNormals();external 

         void computeLineDistances();external 
         ...
         void merge( Geometry geometry , Matrix matrix , num materialIndexOffset );external 

         void mergeMesh( Mesh mesh );external 

        
         num mergeVertices();external 

         void sortFacesByMaterialIndex();external 

         dynamic toJSON();external 

        
         Geometry clone();external 

         Geometry copy(Geometry source );external 
		...
		external set animations(List<AnimationClip> v);external 
...
class InstancedBufferAttribute  extends BufferAttribute  {
	external factory InstancedBufferAttribute ([ List<num> data, num itemSize, num meshPerAttribute ]);

        
         

		external num get meshPerAttribute;
		external set meshPerAttribute(num v);external 

         InstancedBufferAttribute clone();external 
         InstancedBufferAttribute copy(InstancedBufferAttribute source );
...
class InstancedBufferGeometry  extends BufferGeometry  {
	external factory InstancedBufferGeometry ();
		...
		/*         groups #num start , num count , instances:num# []; */external 
         void addGroup(num start , num count , num instances );external 

         InstancedBufferGeometry clone();external 
...
class InstancedInterleavedBuffer  extends InterleavedBuffer  {
	external factory InstancedInterleavedBuffer ([ List<num> array, num stride, num meshPerAttribute ]);
		...
		external set meshPerAttribute(num v);external 
         ...
         InstancedInterleavedBuffer clone();external 
         InstancedInterleavedBuffer copy(InstancedInterleavedBuffer source );
...
/*         updateRange #num offset , count:num# ; */
		...
		external set count(num v);
         external bool get needsUpdate;
		external set needsUpdate(bool v);external 

         InterleavedBuffer setDynamic(bool dynamic );external 
         InterleavedBuffer copy(InterleavedBuffer source );external 
         InterleavedBuffer copyAt(num index1 , InterleavedBufferAttribute attribute , num index2 );external 
         InterleavedBuffer set(List<num> value , num index );
...
class InterleavedBufferAttribute   {
	external factory InterleavedBufferAttribute ([ InterleavedBuffer interleavedBuffer, num itemSize, num offset ]);
		...
		external set count(num v);external 
         ...
         num getX(num index );external 
         InterleavedBufferAttribute setX(num index , num x );external 
         num getY(num index );external 
         InterleavedBufferAttribute setY(num index , num y );external 
         num getZ(num index );external 
         InterleavedBufferAttribute setZ(num index , num z );external 
         num getW(num index );external 
         InterleavedBufferAttribute setW(num index , num z );external 
         InterleavedBufferAttribute setXY(num index , num x , num y );external 
         InterleavedBufferAttribute setXYZ(num index , num x , num y , num z );external 
         InterleavedBufferAttribute setXYZW(num index , num x , num y , num z , num w );
...
class Object3D   {
	external factory Object3D ();
		...
		external set userData(dynamic v);
         ...
         external static Vector3 get DefaultMatrixAutoUpdate;external 

        
         void applyMatrix(Matrix4 matrix );external 

        
         void setRotationFromAxisAngle(Vector3 axis , num angle );external 

        
         void setRotationFromEuler(Euler euler );external 

        
         void setRotationFromMatrix(Matrix4 m );external 

        
         void setRotationFromQuaternion( Quaternion q );external 

        
         Object3D rotateOnAxis(Vector3 axis , num angle );external 

        
         Object3D rotateX(num angle );external 

        
         Object3D rotateY(num angle );external 

        
         Object3D rotateZ(num angle );external 

        
         Object3D translateOnAxis(Vector3 axis , num distance );external 

        
         Object3D translate( num distance , Vector3 axis );external 

        
         Object3D translateX(num distance );external 

        
         Object3D translateY(num distance );external 

        
         Object3D translateZ(num distance );external 

        
         Vector3 localToWorld(Vector3 vector );external 

        
         Vector3 worldToLocal(Vector3 vector );external 

        
         void lookAt(Vector3 vector );external 

        
         void add(Object3D object );external 

        
         void remove(Object3D object );

        /* deprecated */external 
         Object3D getChildByName( String name );external 

        
         Object3D getObjectById(num id );external 

        
         Object3D getObjectByName(String name );external 

         Object3D getObjectByProperty( String name , String value );external 

         Vector3 getWorldPosition(Vector3 optionalTarget );external 
         Quaternion getWorldQuaternion(Quaternion optionalTarget );external 
         Euler getWorldRotation(Euler optionalTarget );external 
         Vector3 getWorldScale(Vector3 optionalTarget );external 
         Vector3 getWorldDirection(Vector3 optionalTarget );external 

         void raycast(Raycaster raycaster , dynamic intersects );external 

         void traverse(VoidFunc1<Object3D> callback);external 

         void traverseVisible(VoidFunc1<Object3D> callback);external 

         void traverseAncestors(VoidFunc1<Object3D> callback);external 

        
         void updateMatrix();external 

        
         void updateMatrixWorld(bool force );external 

         dynamic toJSON(dynamic meta );external 

         Object3D clone(bool recursive );external 

        
         Object3D copy(Object3D source , bool recursive );external 
...
class Raycaster   {
	external factory Raycaster ([ Vector3 origin, Vector3 direction, num near, num far ]);
		...
		external set linePrecision(num v);external 
         void set(Vector3 origin , Vector3 direction );
/*         setFromCamera(coords # x: num; y: num;# , Camera camera ): void; */external 
         List<Intersection> intersectObject(Object3D object , bool recursive );external 
...
class Light  extends Object3D  {
	external factory Light ([ dynamic  hex ]);
		...
		external set shadowMapHeight(num v);external 

         Light clone(bool recursive );external 
         Light copy( Light source );external 
         dynamic toJSON( dynamic meta );
...
class LightShadow   {
	external factory LightShadow ([ Camera camera ]);
		...
		external set map(RenderTarget v);
         external Matrix4 get matrix;
		external set matrix(Matrix4 v);external 

         void copy(LightShadow source );external 
         LightShadow clone();
...
class AmbientLight  extends Light  {
	external factory AmbientLight ([ dynamic  hex ]);
		...
		external AmbientLight clone(bool recursive );external 
         AmbientLight copy(AmbientLight source );
...
class DirectionalLight  extends Light  {
	external factory DirectionalLight ([ dynamic  hex, num intensity ]);
		...
		external set shadow(LightShadow v);external 

         DirectionalLight clone(bool recursive );external 
         DirectionalLight copy(DirectionalLight source );
...
class HemisphereLight  extends Light  {
	external factory HemisphereLight ([ dynamic  skyColorHex, dynamic  groundColorHex, num intensity ]);
		...
		external set groundColor(Color v);
         external num get intensity;
		external set intensity(num v);external 

         HemisphereLight clone(bool recursive );external 
         HemisphereLight copy(HemisphereLight source );
...
class PointLight  extends Light  {
	external factory PointLight ([ dynamic  hex, num intensity, num distance, num decay ]);
		...
		external set shadow(LightShadow v);external 
         ...
         PointLight clone(bool recursive );external 
         PointLight copy(PointLight source );
...
class SpotLight  extends Light  {
	external factory SpotLight ([ dynamic  hex, num intensity, num distance, num angle, num exponent, num decay ]);
		...
		external set shadow(LightShadow v);external 
         ...
         SpotLight clone(bool recursive );external 
         SpotLight copy(PointLight source );
...
class Loader   {
	external factory Loader ();
		...
		external void onLoadStart();external 

        
         void onLoadProgress();external 
		...
		external set crossOrigin(String v);external 

         String extractUrlBase(String url );external 
         List<Material> initMaterials(List<Material> materials , String texturePath );external 
         bool createMaterial(Material m , String texturePath , String crossOrigin );
...
class LoaderHandler  {
	external factory LoaderHandler();
		...
		external set handlers(List<dynamic> v);external 
         void add(String regex , Loader loader );external 
...
class BinaryTextureLoader   {
	external factory BinaryTextureLoader ([ LoadingManager manager ]);
		...
		external set manager(LoadingManager v);external 
         void load(String url , VoidFunc1<DataTexture> onLoad, VoidFunc1<dynamic> onProgress, VoidFunc1<dynamic> onError);external 
...
class BufferGeometryLoader   {
	external factory BufferGeometryLoader ([ LoadingManager manager ]);
		...
		external LoadingManager get manager;
		external set manager(LoadingManager v);external 
         void load(String url , VoidFunc1<BufferGeometry> onLoad, VoidFunc1<dynamic> onProgress, VoidFunc1<dynamic> onError);external 
         void setCrossOrigin(String crossOrigin );external 
         BufferGeometry parse(dynamic json );
...
class Cache   {
	external factory Cache();
		...
		external set files(List<dynamic> v);external 

         void add(String key , dynamic file );external 
         dynamic get(String key );external 
         void remove(String key );external 
         void clear();
...
class CompressedTextureLoader  {
	external factory CompressedTextureLoader ([ LoadingManager manager ]);
		...
		external LoadingManager get manager;
		external set manager(LoadingManager v);external 
         void load(String url , VoidFunc1<CompressedTexture> onLoad, VoidFunc1<dynamic> onProgress, VoidFunc1<dynamic> onError);external 
         void setCrossOrigin(String crossOrigin );
...
class CubeTextureLoader   {
	external factory CubeTextureLoader ([ LoadingManager manager ]);
		...
		external LoadingManager get manager;
		external set manager(LoadingManager v);external 
         void load(List<String> urls , VoidFunc1<CubeTexture> onLoad, VoidFunc1<dynamic> onProgress, VoidFunc1<dynamic> onError);external 
         void setCrossOrigin(String crossOrigin );
...
class ImageLoader   {
	external factory ImageLoader ([ LoadingManager manager ]);
		...
		external set crossOrigin(String v);external 
         ...
         ImageElement load(String url , VoidFunc1<ImageElement> onLoad, VoidFunc1<dynamic> onProgress, VoidFunc1<dynamic> onError);external 
...
class JSONLoader  extends Loader  {
	external factory JSONLoader ([ LoadingManager manager ]);
		...
		external set withCredentials(bool v);external 

         void load(String url , VoidFunc2<Geometry,List<Material>> onLoad, VoidFunc1<dynamic> onProgress, VoidFunc1<dynamic> onError);external 
...
class LoadingManager   {
	external factory LoadingManager ([ VoidFunc0 onLoad, VoidFunc3<String,num,num> onProgress, VoidFunc0 onError ]);

        

         

		external void onStart();external 

        
         void onLoad();external 

        
         void onProgress(dynamic item , num loaded , num total );external 

        
         void onError();external 

         void itemStart(String url );external 
         void itemEnd(String url );external 
...
class MaterialLoader   {
	external factory MaterialLoader ([ LoadingManager manager ]);
		...
		external LoadingManager get manager;
		external set manager(LoadingManager v);
/*         textures # [key:String]:Texture # ; */external 

         void load(String url , VoidFunc1<Material> onLoad);external 
         void setCrossOrigin(String crossOrigin );
/*         setTextures(textures # [key:String]:Texture # ): void; */external 
         Texture getTexture( String name );external 
         Material parse(dynamic json );
...
class ObjectLoader   {
	external factory ObjectLoader ([ LoadingManager manager ]);
		...
		external set texturePass(String v);external 
         ...
         void load(String url , VoidFunc1<Object3D> onLoad);external 
         void setTexturePath( String value );external 
         void setCrossOrigin(String crossOrigin );external 
         dynamic parse(dynamic json , VoidFunc1<Object3D> onLoad);external 
         List<dynamic> parseGeometries(dynamic json );external  
         List<Material> parseMaterials(dynamic json , List<Texture> textures );external  
         List<dynamic> parseImages( dynamic json , VoidFunc0 onLoad );external 
         List<Texture> parseTextures( dynamic json , dynamic images );external 
         dynamic parseObject(dynamic data , List<dynamic> geometries , List<Material> materials );
...
class TextureLoader   {
	external factory TextureLoader ([ LoadingManager manager ]);
		...
		external set crossOrigin(String v);external 
         ...
         Texture load(String url , VoidFunc1<Texture> onLoad);external 
         void setCrossOrigin(String crossOrigin );
...
class XHRLoader   {
	external factory XHRLoader ([ LoadingManager manager ]);
		...
		external set crossOrigin(String v);external 
         ...
         dynamic load(String url , VoidFunc1<String> onLoad, VoidFunc1<dynamic> onProgress, VoidFunc1<dynamic> onError);external 
         void setResponseType(String responseType );external 
         void setCrossOrigin(String crossOrigin );external 
         void setWithCredentials( String withCredentials );
...
class Material   {
	external factory Material ();
		...
		external set needsUpdate(bool v);external 
         ...
         void setValues(Object values );external 
         dynamic toJSON(dynamic meta );external 
         Material clone(Material source );external 
         void update();external 
         void dispose();external 
...
class LineBasicMaterial  extends Material  {
	external factory LineBasicMaterial ([ LineBasicMaterialParameters parameters ]);
		...
		external set vertexColors(Colors v);
         external bool get fog;
		external set fog(bool v);external 

         LineBasicMaterial clone();external 
         LineBasicMaterial copy(LineBasicMaterial source );
...
class LineDashedMaterial  extends Material  {
	external factory LineDashedMaterial ([ LineDashedMaterialParameters parameters ]);
		...
		external set fog(bool v);external 
         ...
         LineDashedMaterial clone();external 
         LineDashedMaterial copy(LineDashedMaterial source );
...
class MeshBasicMaterial  extends Material  {
	external factory MeshBasicMaterial ([ MeshBasicMaterialParameters parameters ]);
		...
		external set skinning(bool v);
         external bool get morphTargets;
		external set morphTargets(bool v);external 

         MeshBasicMaterial clone();external 
         MeshBasicMaterial copy(MeshBasicMaterial source );
...
class MeshDepthMaterial  extends Material  {
	external factory MeshDepthMaterial ([ MeshDepthMaterialParameters parameters ]);
		...
		external set wireframe(bool v);
         external num get wireframeLinewidth;
		external set wireframeLinewidth(num v);external 

         MeshDepthMaterial clone();external 
         MeshDepthMaterial copy(MeshDepthMaterial source );
...
class MeshLambertMaterial  extends Material  {
	external factory MeshLambertMaterial ([ MeshLambertMaterialParameters parameters ]);
		...
		external set morphTargets(bool v);
         external bool get morphNormals;
		external set morphNormals(bool v);external 

         MeshLambertMaterial clone();external 
         MeshLambertMaterial copy(MeshLambertMaterial source );
...
class MeshNormalMaterial  extends Material  {
	external factory MeshNormalMaterial ([ MeshNormalMaterialParameters parameters ]);
		...
		external set morphTargets(bool v);external 
         ...
         MeshNormalMaterial clone();external 
         MeshNormalMaterial copy(MeshNormalMaterial source );
...
class MeshPhongMaterial  extends Material  {
	external factory MeshPhongMaterial ([ MeshPhongMaterialParameters parameters ]);
		...
		external set morphNormals(bool v);external 
         ...
         MeshPhongMaterial clone();external 
         MeshPhongMaterial copy(MeshPhongMaterial source );
...
class MultiMaterial  extends Material  {
	external factory MultiMaterial ([ List<Material> materials ]);
		...
		external set materials(List<Material> v);external 
...
class PointsMaterial  extends Material  {
	external factory PointsMaterial ([ PointsMaterialParameters parameters ]);
		...
		external set fog(bool v);external 
         ...
         PointsMaterial clone();external 
         PointsMaterial copy(PointsMaterial source );
...
class ShaderMaterial  extends Material  {
	external factory ShaderMaterial ([ ShaderMaterialParameters parameters ]);
		...
		external set index0AttributeName(String v);external 

         ShaderMaterial clone();external 
         ShaderMaterial copy(ShaderMaterial source );external 
         dynamic toJSON(dynamic meta );
...
class Box2   {
	external factory Box2 ([ Vector2 min, Vector2 max ]);
		...
		external set min(Vector2 v);external 

         Box2 set(Vector2 min , Vector2 max );external 
         Box2 setFromPoints(List<Vector2> points );external 
         Box2 setFromCenterAndSize(Vector2 center , Vector2 size );external 
         Box2 clone();external 
         Box2 copy(Box2 box );external 
         Box2 makeEmpty();external 
         bool empty();external 
         Vector2 center(Vector2 optionalTarget );external 
         Vector2 size(Vector2 optionalTarget );external 
         Box2 expandByPoint(Vector2 point );external 
         Box2 expandByVector(Vector2 vector );external 
         Box2 expandByScalar(num scalar );external 
         bool containsPoint(Vector2 point );external 
         bool containsBox(Box2 box );external 
         Vector2 getParameter(Vector2 point );external 
         bool isIntersectionBox(Box2 box );external 
         Vector2 clampPoint(Vector2 point , Vector2 optionalTarget );external 
         num distanceToPoint(Vector2 point );external 
         Box2 intersect(Box2 box );external 
         Box2 union(Box2 box );external 
         Box2 translate(Vector2 offset );external 
...
class Box3   {
	external factory Box3 ([ Vector3 min, Vector3 max ]);
		...
		external set min(Vector3 v);external 

         Box3 set(Vector3 min , Vector3 max );external 
         Box3 setFromPoints(List<Vector3> points );external 
         Box3 setFromCenterAndSize(Vector3 center , Vector3 size );external 
         Box3 setFromObject(Object3D object );external 
         Box3 clone();external 
         Box3 copy(Box3 box );external 
         Box3 makeEmpty();external 
         bool empty();external 
         Vector3 center(Vector3 optionalTarget );external 
         Vector3 size(Vector3 optionalTarget );external 
         Box3 expandByPoint(Vector3 point );external 
         Box3 expandByVector(Vector3 vector );external 
         Box3 expandByScalar(num scalar );external 
         bool containsPoint(Vector3 point );external 
         bool containsBox(Box3 box );external 
         Vector3 getParameter(Vector3 point );external 
         bool isIntersectionBox(Box3 box );external 
         Vector3 clampPoint(Vector3 point , Vector3 optionalTarget );external 
         num distanceToPoint(Vector3 point );external 
         Sphere getBoundingSphere(Sphere optionalTarget );external 
         Box3 intersect(Box3 box );external 
         Box3 union(Box3 box );external 
         Box3 applyMatrix4(Matrix4 matrix );external 
         Box3 translate(Vector3 offset );external 
...
class Color   {
	external factory Color ([ num r, num g, num b ]);
		...
		external set g(num v);
         ...
         external num get b;
		external set b(num v);external 
         Color set(num color );external 
         Color setHex(num hex );external 

        
         Color setRGB(num r , num g , num b );external 

        
         Color setHSL(num h , num s , num l );external 

        
         Color setStyle(String style );external 

        
         Color clone();external 

        
         Color copy(Color color );external 

        
         Color copyGammaToLinear(Color color , num gammaFactor );external 

        
         Color copyLinearToGamma(Color color , num gammaFactor );external 

        
         Color convertGammaToLinear();external 

        
         Color convertLinearToGamma();external 

        
         num getHex();external 

        
         String getHexString();external 

         HSL getHSL();external 

        
         String getStyle();external 

         Color offsetHSL(num h , num s , num l );external 

         Color add(Color color );external 
         Color addColors(Color color1 , Color color2 );external 
         Color addScalar(num s );external 
         Color multiply(Color color );external 
         Color multiplyScalar(num s );external 
         Color lerp(Color color , num alpha );external 
         bool equals(Color color );external 
         Color fromArray(List<num> rgb , num offset );external 
         List<num> toArray(List<num> array , num offset );
...
class Euler   {
	external factory Euler ([ num x, num y, num z, String order ]);
		...
		external set order(String v);external 

         Euler set(num x , num y , num z , String order );external 
         Euler clone();external 
         Euler copy(Euler euler );external 
         Euler setFromRotationMatrix(Matrix4 m , String order , bool update );external 
         Euler setFromQuaternion(Quaternion q , String order , bool update );external 
         Euler setFromVector3( Vector3 v , String order );external 
         Euler reorder(String newOrder );external 
         bool equals(Euler euler );external 
         Euler fromArray(List<dynamic> xyzo );external 
         List<num> toArray(List<num> array , num offset );external 
         Vector3 toVector3(Vector3 optionalResult );external 
         void onChange();
...
class Frustum   {
	external factory Frustum ([ Plane p0, Plane p1, Plane p2, Plane p3, Plane p4, Plane p5 ]);
		...
		external set planes(List<Plane> v);external 

         Frustum set(num p0 , num p1 , num p2 , num p3 , num p4 , num p5 );external 
         Frustum clone();external 
         Frustum copy(Frustum frustum );external 
         Frustum setFromMatrix(Matrix4 m );external 
         bool intersectsObject(Object3D object );external 
         bool intersectsSphere(Sphere sphere );external 
         bool intersectsBox(Box3 box );external 
...
class Line3   {
	external factory Line3 ([ Vector3 start, Vector3 end ]);
		...
		external set end(Vector3 v);external 

         Line3 set(Vector3 start , Vector3 end );external 
         Line3 clone();external 
         Line3 copy(Line3 line );external 
         Vector3 center(Vector3 optionalTarget );external 
         Vector3 delta(Vector3 optionalTarget );external 
         num distanceSq();external 
         num distance();external 
         Vector3 at(num t , Vector3 optionalTarget );external 
         num closestPointToPointParameter(Vector3 point , bool clampToLine );external 
         Vector3 closestPointToPoint(Vector3 point , bool clampToLine , Vector3 optionalTarget );external 
         Line3 applyMatrix4(Matrix4 matrix );external 
...
class Math   {
	external factory Math();
		...
		external String generateUUID();external 

        
         num clamp(num value , num min , num max );external 
         num euclideanModulo( num n , num m );external 

        
         num mapLinear(num x , num a1 , num a2 , num b1 , num b2 );external 

         num smoothstep(num x , num min , num max );external 

         num smootherstep(num x , num min , num max );external 

        
         num random16();external 

        
         num randInt(num low , num high );external 

        
         num randFloat(num low , num high );external 

        
         num randFloatSpread(num range );external 

         num degToRad(num degrees );external 

         num radToDeg(num radians );external 

         bool isPowerOfTwo(num value );external 

         num nearestPowerOfTwo(num value );external 

         num nextPowerOfTwo(num value );
...
class Matrix   {
	external factory Matrix();
		...
		external set elements(List v);external 

        
         Matrix identity();external 

        
         Matrix copy(Matrix m );external 

        
         Matrix multiplyScalar(num s );external 

         num determinant();external 

        
         Matrix getInverse(Matrix matrix , bool throwOnInvertible );external 

        
         Matrix transpose();external 
...
class Matrix3    {
	external factory Matrix3 ([ num n11, num n12, num n13, num n21, num n22, num n23, num n31, num n32, num n33 ]);
		...
		external set elements(List v);external 
         ...
         Matrix3 set(num n11 , num n12 , num n13 , num n21 , num n22 , num n23 , num n31 , num n32 , num n33 );external 
         Matrix3 identity();external 
         Matrix3 clone();external 
         Matrix3 copy(Matrix3 m );external 
         List<num> applyToVector3Array(List<num> array , num offset , num length );external 
         BufferAttribute applyToBuffer( BufferAttribute buffer , num offset , num length );external 
         Matrix3 multiplyScalar(num s );external 
         num determinant();external 
         Matrix3 getInverse(Matrix3 matrix , bool throwOnInvertible );external 

        
         Matrix3 transpose();external 
         List<num> flattenToArrayOffset(List<num> array , num offset );external 
         Matrix3 getNormalMatrix(Matrix4 m );external 

        
         List<num> transposeIntoArray(List<num> r );external 
         Matrix3 fromArray(List<num> array );external 
         List<num> toArray();
...
@JS()
class Matrix4    {
	external factory Matrix4 ([ num n11, num n12, num n13, num n14, num n21, num n22, num n23, num n24, num n31, num n32, num n33, num n34, num n41, num n42, num n43, num n44 ]);
		...
		external set elements(List v);external 
         ...
         Matrix4 set(num n11 , num n12 , num n13 , num n14 , num n21 , num n22 , num n23 , num n24 , num n31 , num n32 , num n33 , num n34 , num n41 , num n42 , num n43 , num n44 );external 

        
         Matrix4 identity();external 
         Matrix4 clone();external 
         Matrix4 copy(Matrix4 m );external 
         Matrix4 copyPosition(Matrix4 m );external 
         Matrix4 extractBasis( Vector3 xAxis , Vector3 yAxis , Vector3 zAxis );external 
         Matrix4 makeBasis( Vector3 xAxis , Vector3 yAxis , Vector3 zAxis );external 

        
         Matrix4 extractRotation(Matrix4 m );external 
         Matrix4 makeRotationFromEuler(Euler euler );external 
         Matrix4 makeRotationFromQuaternion(Quaternion q );external 
        
         Matrix4 lookAt(Vector3 eye , Vector3 target , Vector3 up );external 

        
         Matrix4 multiply(Matrix4 m );external 

        
         Matrix4 multiplyMatrices(Matrix4 a , Matrix4 b );external 

        
         Matrix4 multiplyToArray(Matrix4 a , Matrix4 b , List<num> r );external 

        
         Matrix4 multiplyScalar(num s );external 
         List<num> applyToVector3Array(List<num> array , num offset , num length );external 
         BufferAttribute applyToBuffer( BufferAttribute buffer , num offset , num length );external 
         ...
         Matrix4 transpose();external 

        
         List<num> flattenToArrayOffset(List<num> array , num offset );external 

        
         Vector3 setPosition(Vector3 v );external 

        
         Matrix4 getInverse(Matrix4 m , bool throwOnInvertible );external 

        
         Matrix4 scale(Vector3 v );external 

         num getMaxScaleOnAxis();external 
        
         Matrix4 makeTranslation(num x , num y , num z );external 

        
         Matrix4 makeRotationX(num theta );external 

        
         Matrix4 makeRotationY(num theta );external 

        
         Matrix4 makeRotationZ(num theta );external 

        
         Matrix4 makeRotationAxis(Vector3 axis , num angle );external 

        
         Matrix4 makeScale(num x , num y , num z );external 

        
         Matrix4 compose(Vector3 translation , Quaternion rotation , Vector3 scale );external 

        
         List<Object> decompose(Vector3 translation , Quaternion rotation , Vector3 scale );external  

        
         Matrix4 makeFrustum(num left , num right , num bottom , num top , num near , num far );external 

        
         Matrix4 makePerspective(num fov , num aspect , num near , num far );external 

        
         Matrix4 makeOrthographic(num left , num right , num top , num bottom , num near , num far );external 
         bool equals( Matrix4 matrix );external 
         Matrix4 fromArray(List<num> array );external 
         List<num> toArray();
...
class Plane   {
	external factory Plane ([ Vector3 normal, num constant ]);
		...
		external set constant(num v);external 

         Plane set(Vector3 normal , num constant );external 
         Plane setComponents(num x , num y , num z , num w );external 
         Plane setFromNormalAndCoplanarPoint(Vector3 normal , Vector3 point );external 
         Plane setFromCoplanarPoints(Vector3 a , Vector3 b , Vector3 c );external 
         Plane clone();external 
         Plane copy(Plane plane );external 
         Plane normalize();external 
         Plane negate();external 
         num distanceToPoint(Vector3 point );external 
         num distanceToSphere(Sphere sphere );external 
         Vector3 projectPoint(Vector3 point , Vector3 optionalTarget );external 
         Vector3 orthoPoint(Vector3 point , Vector3 optionalTarget );external 
         bool isIntersectionLine(Line3 line );external 
         Vector3 intersectLine(Line3 line , Vector3 optionalTarget );external 
         Vector3 coplanarPoint(bool optionalTarget );external 
         Plane applyMatrix4(Matrix4 matrix , Matrix3 optionalNormalMatrix );external 
         Plane translate(Vector3 offset );external 
...
class Quaternion   {
	external factory Quaternion ([ num x, num y, num z, num w ]);
		...
		external set z(num v);
         external num get w;
		external set w(num v);external 

        
         Quaternion set(num x , num y , num z , num w );external 

        
         Quaternion clone();external 

        
         Quaternion copy(Quaternion q );external 

        
         Quaternion setFromEuler(Euler euler , bool update );external 

        
         Quaternion setFromAxisAngle(Vector3 axis , num angle );external 

        
         Quaternion setFromRotationMatrix(Matrix4 m );external 
         Quaternion setFromUnitVectors(Vector3 vFrom , Vector3 vTo );external 
        
         Quaternion inverse();external 

         Quaternion conjugate();external 
         num dot(Vector3 v );external 
         num lengthSq();external 

        
         num length();external 

        
         Quaternion normalize();external 

        
         Quaternion multiply(Quaternion q );external 

        
         Quaternion multiplyQuaternions(Quaternion a , Quaternion b );external 

        
         Vector3 multiplyVector3(Vector3 vector );external 
         Quaternion slerp(Quaternion qb , num t );external 
         bool equals(Quaternion v );external 
         Quaternion fromArray(List<num> n );external 
         List<num> toArray();external 
...
class Ray   {
	external factory Ray ([ Vector3 origin, Vector3 direction ]);
		...
		external set direction(Vector3 v);external 

         Ray set(Vector3 origin , Vector3 direction );external 
         Ray clone();external 
         Ray copy(Ray ray );external 
         Vector3 at(num t , Vector3 optionalTarget );external 
         Ray recast(num t );external 
         Vector3 closestPointToPoint(Vector3 point , Vector3 optionalTarget );external 
         num distanceToPoint(Vector3 point );external 
         num distanceSqToPoint(Vector3 point );external 
         num distanceSqToSegment(Vector3 v0 , Vector3 v1 , Vector3 optionalPointOnRay , Vector3 optionalPointOnSegment );external 
         bool isIntersectionSphere(Sphere sphere );external 
         Vector3 intersectSphere(Sphere sphere , Vector3 optionalTarget );external 
         bool isIntersectionPlane(Plane plane );external 
         num distanceToPlane(Plane plane );external 
         Vector3 intersectPlane(Plane plane , Vector3 optionalTarget );external 
         bool isIntersectionBox(Box3 box );external 
         Vector3 intersectBox(Box3 box , Vector3 optionalTarget );external 
         Vector3 intersectTriangle(Vector3 a , Vector3 b , Vector3 c , bool backfaceCulling , Vector3 optionalTarget );external 
         Ray applyMatrix4(Matrix4 matrix4 );external 
         bool equals(Ray ray );
...
class Sphere   {
	external factory Sphere ([ Vector3 center, num radius ]);
		...
		external set center(Vector3 v);
         external num get radius;
		external set radius(num v);external 

         Sphere set(Vector3 center , num radius );external 
         Sphere setFromPoints(List<Vector3> points , Vector3 optionalCenter );external 
         Sphere clone();external 
         Sphere copy(Sphere sphere );external 
         bool empty();external 
         bool containsPoint(Vector3 point );external 
         num distanceToPoint(Vector3 point );external 
         bool intersectsSphere(Sphere sphere );external 
         Vector3 clampPoint(Vector3 point , Vector3 optionalTarget );external 
         Box3 getBoundingBox(Box3 optionalTarget );external 
         Sphere applyMatrix4(Matrix4 matrix );external 
         Sphere translate(Vector3 offset );external 
...
class Spline   {
	external factory Spline ([ List<SplineControlPoint> points ]);
		...
		external set points(List<SplineControlPoint> v);external 

        
         void initFromArray(List<List<num>> a );external 

        
         SplineControlPoint getPoint(num k );external 

        
         List<List<num>> getControlPointsArray();

        
/*         getLength(num nSubDivisions ) # chunks: List<num>; total: num; # ; */external 

        
         void reparametrizeByArcLength(num samplingCoef );
...
class Triangle   {
	external factory Triangle ([ Vector3 a, Vector3 b, Vector3 c ]);
		...
		external set c(Vector3 v);external 

         Triangle set(Vector3 a , Vector3 b , Vector3 c );external 
         Triangle setFromPointsAndIndices(List<Vector3> points , num i0 , num i1 , num i2 );external 
         Triangle clone();external 
         Triangle copy(Triangle triangle );external 
         num area();external 
         Vector3 midpoint(Vector3 optionalTarget );external 
         Vector3 normal(Vector3 optionalTarget );external 
         Plane plane(Vector3 optionalTarget );external 
         Vector3 barycoordFromPoint(Vector3 point , Vector3 optionalTarget );external 
         bool containsPoint(Vector3 point );external 
...
class Vector   {
	external factory Vector();
		...
		external void setComponent(num index , num value );external 

         num getComponent(num index );external 

        
         Vector copy(Vector v );external 

        
         Vector add(Vector v );external 

        
         Vector addVectors(Vector a , Vector b );external 

        
         Vector sub(Vector v );external 

        
         Vector subVectors(Vector a , Vector b );external 

        
         Vector multiplyScalar(num s );external 

        
         Vector divideScalar(num s );external 

        
         Vector negate();external 

        
         num dot(Vector v );external 
         ...
         Vector normalize();external 

        
         num distanceTo(Vector v );external 

        
         num distanceToSquared(Vector v );external 

        
         Vector setLength(num l );external 

        
         Vector lerp(Vector v , num alpha );external 

        
         bool equals(Vector v );external 
...
class Vector2 extends Vector    {
	external factory Vector2 ([ num x, num y ]);
		...
		external set height(num v);external 

        
         Vector2 set(num x , num y );external 

        
         Vector2 setX(num x );external 

        
         Vector2 setY(num y );external 

        
         void setComponent(num index , num value );external 

        
         num getComponent(num index );external 
        
         Vector2 clone();external 
        
         Vector2 copy(Vector2 v );external 

        
         Vector2 add(Vector2 v );external 

        
         Vector2 addScalar(num s );external 
         Vector2 addVectors(Vector2 a , Vector2 b );external 
         Vector2 addScaledVector( Vector2 v , num s );external 
        
         Vector2 sub(Vector2 v );external 

        
         Vector2 subVectors(Vector2 a , Vector2 b );external 

         Vector2 multiply(Vector2 v );external 
        
         Vector2 multiplyScalar(num scalar );external 

         Vector2 divide(Vector2 v );external 
        
         Vector2 divideScalar(num s );external 

         Vector2 min(Vector2 v );external 

         Vector2 max(Vector2 v );external 
         Vector2 clamp(Vector2 min , Vector2 max );external 
         Vector2 clampScalar(num min , num max );external 
         Vector2 clampLength(num min , num max );external 
         Vector2 floor();external 
         Vector2 ceil();external 
         Vector2 round();external 
         Vector2 roundToZero();external 

        
         Vector2 negate();external 

        
         num dot(Vector2 v );external 
         ...
         num length();external 
         num lengthManhattan();external 

        
         Vector2 normalize();external 

        
         num distanceTo(Vector2 v );external 

        
         num distanceToSquared(Vector2 v );external 

        
         Vector2 setLength(num length );external 

         Vector2 lerp(Vector2 v , num alpha );external 

         Vector2 lerpVectors(Vector2 v1 , Vector2 v2 , num alpha );external 

        
         bool equals(Vector2 v );external 

         Vector2 fromArray(List<num> xy , num offset );external 

         List<num> toArray(List<num> xy , num offset );external 

         Vector2 fromAttribute( BufferAttribute attribute , num index , num offset );external 
...
class Vector3 extends Vector    {
	external factory Vector3 ([ num x, num y, num z ]);
		...
		external set y(num v);
         external num get z;
		external set z(num v);external 

        
         Vector3 set(num x , num y , num z );external 

        
         Vector3 setX(num x );external 

        
         Vector3 setY(num y );external 

        
         Vector3 setZ(num z );external 

         void setComponent(num index , num value );external 
         num getComponent(num index );external 
        
         Vector3 clone();external 
        
         Vector3 copy(Vector3 v );external 

        
         Vector3 add(Vector3 a );external 
         Vector3 addScalar(num s );external 
         Vector3 addScaledVector(Vector3 v , num s );external 

        
         Vector3 addVectors(Vector3 a , Vector3 b );external 
          

        
         Vector3 sub(Vector3 a );external 

         Vector3 subScalar( num s );external 

        
         Vector3 subVectors(Vector3 a , Vector3 b );external 

         Vector3 multiply(Vector3 v );external 
        
         Vector3 multiplyScalar(num s );external 
         Vector3 multiplyVectors(Vector3 a , Vector3 b );external 
         Vector3 applyEuler(Euler euler );external 
         Vector3 applyAxisAngle(Vector3 axis , num angle );external 
         Vector3 applyMatrix3(Matrix3 m );external 
         Vector3 applyMatrix4(Matrix4 m );external 
         Vector3 applyProjection(Matrix4 m );external 
         Vector3 applyQuaternion(Quaternion q );external 
         Vector3 project(Camera camrea );external 
         Vector3 unproject(Camera camera );external 
         Vector3 transformDirection(Matrix4 m );external 
         Vector3 divide(Vector3 v );external 

        
         Vector3 divideScalar(num s );external 
         Vector3 min(Vector3 v );external 
         Vector3 max(Vector3 v );external 
         Vector3 clamp(Vector3 min , Vector3 max );external 
         Vector3 clampScalar(num min , num max );external 
         Vector3 clampLength(num min , num max );external 
         Vector3 floor();external 
         Vector3 ceil();external 
         Vector3 round();external 
         Vector3 roundToZero();external 

        
         Vector3 negate();external 
         ...
         Vector3 normalize();external 

        
         Vector3 setLength(num l );external 
         Vector3 lerp(Vector3 v , num alpha );external 

         Vector3 lerpVectors(Vector3 v1 , Vector3 v2 , num alpha );external 

        
         Vector3 cross(Vector3 a );external 

        
         Vector3 crossVectors(Vector3 a , Vector3 b );external 
         Vector3 projectOnVector(Vector3 v );external 
         Vector3 projectOnPlane(Vector3 planeNormal );external 
         Vector3 reflect(Vector3 vector );external 
         num angleTo(Vector3 v );external 

        
         num distanceTo(Vector3 v );external 

        
         num distanceToSquared(Vector3 v );external 

         Vector3 setFromMatrixPosition(Matrix4 m );external 
         Vector3 setFromMatrixScale(Matrix4 m );external 
         Vector3 setFromMatrixColumn(num index , Matrix4 matrix );external 

        
         bool equals(Vector3 v );external 

         Vector3 fromArray(List<num> xyz , num offset );external 

         List<num> toArray(List<num> xyz , num offset );external 

         Vector3 fromAttribute( BufferAttribute attribute , num index , num offset );
...
class Vector4 extends Vector    {
	external factory Vector4 ([ num x, num y, num z, num w ]);
		...
		external set w(num v);external 
         ...
         Vector4 set(num x , num y , num z , num w );external 

        
         Vector4 setX(num x );external 

        
         Vector4 setY(num y );external 

        
         Vector4 setZ(num z );external 

        
         Vector4 setW(num w );external 

         void setComponent(num index , num value );external 
         num getComponent(num index );external 
        
         Vector4 clone();external 
        
         Vector4 copy(Vector4 v );external 

        
         Vector4 add(Vector4 v );external 
         Vector4 addScalar(num s );external 

        
         Vector4 addVectors(Vector4 a , Vector4 b );external 
         Vector4 addScaledVector( Vector4 v , num s );external 
        
         Vector4 sub(Vector4 v );external 

         Vector4 subScalar(num s );external 

        
         Vector4 subVectors(Vector4 a , Vector4 b );external 

        
         Vector4 multiplyScalar(num s );external 
         Vector4 applyMatrix4(Matrix4 m );external 

        
         Vector4 divideScalar(num s );external 

        
         Vector4 setAxisAngleFromQuaternion(Quaternion q );external 

        
         Vector4 setAxisAngleFromRotationMatrix(Matrix4 m );external 

         Vector4 min(Vector4 v );external 
         Vector4 max(Vector4 v );external 
         Vector4 clamp(Vector4 min , Vector4 max );external 
         Vector4 clampScalar(num min , num max );external 
         Vector4 floor();external 
         Vector4 ceil();external 
         Vector4 round();external 
         Vector4 roundToZero();external 

        
         Vector4 negate();external 

        
         num dot(Vector4 v );external 
         ...
         Vector4 normalize();external 
        
         Vector4 setLength(num length );external 

        
         Vector4 lerp(Vector4 v , num alpha );external 

         Vector4 lerpVectors(Vector4 v1 , Vector4 v2 , num alpha );external 

        
         bool equals(Vector4 v );external 

         Vector4 fromArray(List<num> xyzw , num offset );external 

         Vector4 fromAttribute( BufferAttribute attribute , num index , num offset );
...
class Bone  extends Object3D  {
	external factory Bone ([ SkinnedMesh skin ]);
		...
		external set skin(SkinnedMesh v);external 

         Bone clone();external 
         Bone copy(Bone source );
...
class LOD  extends Object3D  {
	external factory LOD ();
		...
		external set levels(List<dynamic> v);external 

         void addLevel(Object3D object , num distance );external 
         Object3D getObjectForDistance(num distance );external 
         void raycast(Raycaster raycaster , dynamic intersects );external 
         void update(Camera camera );external 

         LOD clone();external 
         LOD copy(LOD source );external 
         dynamic toJSON(dynamic meta );
...
class LensFlare  extends Object3D  {
	external factory LensFlare ([ Texture texture, num size, num distance, Blending blending, Color color ]);
		...
		external set positionScreen(Vector3 v);external 
         void customUpdateCallback(LensFlare object );external 

         void add(Texture texture , num size , num distance , Blending blending , Color color );external 

         void updateLensFlares();external 

         LensFlare clone();external 
         LensFlare copy(LensFlare source );
...
class Line  extends Object3D  {
	external factory Line (
		...
		external set material(Material v);external  

         void raycast(Raycaster raycaster , dynamic intersects );external 
         Line clone();external 
         Line copy(Line source );
...
class LineSegments  extends Line  {
	external factory LineSegments (
		...
		external LineSegments clone();external 
         LineSegments copy(LineSegments source );
...
class Mesh  extends Object3D  {
	external factory Mesh ([ BufferGeometry geometry, Material material ]);
		...
		external set material(Material v);external 
         ...
         void updateMorphTargets();external 
         num getMorphTargetIndexByName(String name );external 
         void raycast(Raycaster raycaster , dynamic intersects );external 
         Mesh clone();external 
...
class Points  extends Object3D  {
	external factory Points (
		...
		external set material(Material v);external 
         ...
         void raycast(Raycaster raycaster , dynamic intersects );external 
         Points clone();external 
         Points copy(Points source );
...
class Skeleton   {
	external factory Skeleton ([ List<Bone> bones, List<Matrix4> boneInverses, bool useVertexTexture ]);
		...
		external set boneInverses(List<Matrix4> v);external 

         void calculateInverses(Bone bone );external 
         void pose();external 
         void update();external 
         Skeleton clone();
...
class SkinnedMesh  extends Mesh  {
	external factory SkinnedMesh ([ dynamic  geometry, ShaderMaterial material, bool useVertexTexture ]);
		...
		external set bindMatrixInverse(Matrix4 v);external 

         void bind( Skeleton skeleton , Matrix4 bindMatrix );external 
         void pose();external 
         void normalizeSkinWeights();external 
         void updateMatrixWorld(bool force );external 
         SkinnedMesh clone();external 
         SkinnedMesh copy(SkinnedMesh source );
...
class Sprite  extends Object3D  {
	external factory Sprite ([ Material material ]);
		...
		external set material(SpriteMaterial v);external 

         void raycast(Raycaster raycaster , dynamic intersects );external 
         Sprite clone();external 
         Sprite copy(Sprite source );
...
class Renderer   {
	external factory Renderer();
		...
		external void render(Scene scene , Camera camera );external 
         void setSize(num width , num height , bool updateStyle );
...
class WebGLRenderer    {
	external factory WebGLRenderer ([ WebGLRendererParameters parameters ]);
		...
		external set shadowMap(WebGLShadowMapInstance v);external 

        
         WebGLRenderingContext getContext();external 
        ...
        /** Deprecated, use capabilities instead */external 
         bool supportsVertexTextures();external 
         bool supportsFloatTextures();external 
         bool supportsStandardDerivatives();external 
         bool supportsCompressedTextureS3TC();external 
         bool supportsCompressedTexturePVRTC();external 
         bool supportsBlendMinMax();external 
         String getPrecision();external 

         num getMaxAnisotropy();external 
         num getPixelRatio();external 
         void setPixelRatio(num value );

/*         getSize() # width: num; height: num; # ; */external 

        
         void setSize(num width , num height , bool updateStyle );external 

        
         void setViewport(num x , num y , num width , num height );external 

        
         void setScissor(num x , num y , num width , num height );external 

        
         void enableScissorTest(bool enable );external 
         void setClearColor(String color , num alpha );external 

         void setClearAlpha(num alpha );external 

        
         void setClearColorHex(num hex , num alpha );external 

        
         Color getClearColor();external 

        
         num getClearAlpha();external 

        
         void clear(bool color , bool depth , bool stencil );external 

         void clearColor();external 
         void clearDepth();external 
         void clearStencil();external 
         void clearTarget(WebGLRenderTarget renderTarget , bool color , bool depth , bool stencil );external 
         void resetGLState();external 
         void dispose();external 

        
         void updateShadowMap(Scene scene , Camera camera );external 

         void renderBufferImmediate(Object3D object , Object program , Material material );external 

         void renderBufferDirect(Camera camera , List<Light> lights , Fog fog , Material material , dynamic geometryGroup , Object3D object );external 

         void renderBuffer(Camera camera , List<Light> lights , Fog fog , Material material , dynamic geometryGroup , Object3D object );external 

        
         void render(Scene scene , Camera camera , RenderTarget renderTarget , bool forceClear );external 
         void renderImmediateObject(Camera camera , List<Light> lights , Fog fog , Material material , Object3D object );external 

        
         void setFaceCulling(CullFace cullFace , FrontFaceDirection frontFace );external 
         void setMaterialFaces(Material material );external 
         void setDepthTest(bool depthTest );external 
         void setDepthWrite(bool depthWrite );external 
         void setBlending(Blending blending , BlendingEquation blendEquation , BlendingSrcFactor blendSrc , BlendingDstFactor blendDst );external 
         void uploadTexture(Texture texture );external 
         void setTexture(Texture texture , num slot );external 
         void setRenderTarget(RenderTarget renderTarget );external 
         void readRenderTargetPixels( RenderTarget renderTarget , num x , num y , num width , num height , dynamic buffer );
...
class WebGLRenderTarget    {
	external factory WebGLRenderTarget ([ num width, num height, WebGLRenderTargetOptions options ]);
		...
		external set shareDepthFrom(dynamic v);external 

         void setSize(num width , num height );external 
         WebGLRenderTarget clone();external 
         WebGLRenderTarget copy(WebGLRenderTarget source );external 
         void dispose();external 
...
class WebGLRenderTargetCube  extends WebGLRenderTarget  {
	external factory WebGLRenderTargetCube ([ num width, num height, WebGLRenderTargetOptions options ]);
...
class UniformsUtils    {
	external factory UniformsUtils();
		...
		external dynamic merge(List<dynamic> uniforms );external 
         dynamic clone(dynamic uniforms_src );
...
class WebGLBufferRenderer  {
	external factory WebGLBufferRenderer ([ dynamic _gl, dynamic extensions, dynamic _infoRender ]);

         

         

		external void setMode( dynamic value );external 
         void render( dynamic start , dynamic count );external 
         void renderInstances( dynamic geometry );
...
class WebGLCapabilities  {
	external factory WebGLCapabilities ([ dynamic gl, dynamic extensions, dynamic parameters ]);
...
class WebGLIndexedBufferRendererInstance   {
	external factory WebGLIndexedBufferRendererInstance();
		...
		external void setMode( dynamic value );external 
         void setIndex( dynamic index );external 
         void render( dynamic start , dynamic count );external 
         void renderInstances( dynamic geometry );
...
class WebGLObjectsInstance   {
	external factory WebGLObjectsInstance();
		...
		external dynamic getAttributeBuffer( dynamic attribute );external 
         dynamic getWireframeAttribute(dynamic geometry );external 
...
@JS()
class WebGLProgram  {
	external factory WebGLProgram ([ WebGLRenderer renderer, String code, ShaderMaterial material, WebGLRendererParameters parameters ]);
		...
		external set getUniforms(Func0<dynamic> v);external 
...
class WebGLProgramsInstance   {
	external factory WebGLProgramsInstance();
		...
		external List<dynamic> getParameters( dynamic material , dynamic lights , dynamic fog , dynamic object );external 
         dynamic getProgramCode( dynamic material , dynamic parameters );external 
         dynamic acquireProgram( dynamic material , dynamic parameters , dynamic code );external 
         void releaseProgram( dynamic program );
...
class WebGLPropertiesInstance   {
	external factory WebGLPropertiesInstance();
		...
		external dynamic get(dynamic object );external 
         void delete(dynamic object );external 
         void clear();
...
class WebGLShadowMapInstance  {
	external factory WebGLShadowMapInstance();
		...
		external set cullFace(CullFace v);external 
...
class WebGLStateInstance  {
	external factory WebGLStateInstance();
		...
		external void init();external 
         void initAttributes();external 
         void enableAttribute(String attribute );external 
         void enableAttributeAndDivisor( String attribute , dynamic meshPerAttribute , dynamic extension );external 
         void disableUnusedAttributes();external 
         void enable( String id );external 
         void disable( String id );external 
         dynamic getCompressedTextureFormats();external 
         void setBlending( num blending , num blendEquation , num blendSrc , num blendDst , num blendEquationAlpha , num blendSrcAlpha , num blendDstAlpha );external 
         void setDepthFunc( Function func );external 
         void setDepthTest( num depthTest );external 
         void setDepthWrite( num depthWrite );external 
         void setColorWrite( num colorWrite );external 
         void setFlipSided( num flipSided );external 
         void setLineWidth( num width );external 
         void setPolygonOffset(num polygonoffset , num factor , num units );external 
         void setScissorTest( bool scissorTest );external 
         void activeTexture( dynamic webglSlot );external 
         void bindTexture( dynamic webglType , dynamic webglTexture );external 
         void compressedTexImage2D();external 
         void texImage2D();external 
         void reset();
...
class RendererPlugin   {
	external factory RendererPlugin();
		...
		external void init(WebGLRenderer renderer );external 
         void render(Scene scene , Camera camera , num currentWidth , num currentHeight );
...
class LensFlarePlugin    {
	external factory LensFlarePlugin ();
		...
		external void init(Renderer renderer );external 
         void render(Scene scene , Camera camera , num viewportWidth , num viewportHeight );
...
class IFog   {
	external factory IFog();
		...
		external set name(String v);
         external Color get color;
		external set color(Color v);external 
         IFog clone();
...
class FogExp2    {
	external factory FogExp2 ([ dynamic  hex, num density ]);
		...
		external set density(num v);external 
...
class Scene  extends Object3D  {
	external factory Scene ();
		...
		external set overrideMaterial(Material v);
         external bool get autoUpdate;
		external set autoUpdate(bool v);external 

         Scene copy(Scene source );
...
class CubeTexture  extends Texture  {
	external factory CubeTexture (
		...
		external set images(List<dynamic> v);external 

         CubeTexture copy(CubeTexture source );
...
class DataTexture  extends Texture  {
	external factory DataTexture (
		...
		/*         image # data: ImageData; width: num; height: num; # ; */
         external TextureFilter get magFilter;
		external set magFilter(TextureFilter v);
         external TextureFilter get minFilter;
		external set minFilter(TextureFilter v);
...
class Texture   {
	external factory Texture (
		...
		external set needsUpdate(bool v);external 
         ...
         external static dynamic get DEFAULT_MAPPING;external 

         Texture clone();external 
         Texture copy(Texture source );external 
         dynamic toJSON(dynamic meta );external 
         void dispose();external 
         void transformUv( Vector uv );external 
...
class ImageUtils    {
	external factory ImageUtils();
		...
		external set crossOrigin(String v);external 
         ...
         Texture loadTexture(String url , Mapping mapping , VoidFunc1<Texture> onLoad, VoidFunc1<String> onError);external 

        
         Texture loadTextureCube(List<String> array , Mapping mapping , VoidFunc1<Texture> onLoad , VoidFunc1<String> onError );external 

        
         CanvasElement getNormalMap(ImageElement image , num depth );external 
...
class SceneUtils    {
	external factory SceneUtils();
		...
		external Object3D createMultiMaterialObject(Geometry geometry , List<Material> materials );external 
         void detach(Object3D child , Object3D parent , Scene scene );external 
...
class ShapeUtils    {
	external factory ShapeUtils();
		...
		external num area( List<num> contour );external 
         List<num> triangulate( List<num> contour , bool indices );external 
         List<num> triangulateShape( List<num> contour , List<dynamic> holes );external 
         bool isClockWise( List<num> pts );external 
         num b2( num t , num p0 , num p1 , num p2 );external 
...
class Audio  extends Object3D  {
	external factory Audio ([ AudioListener listener ]);
		...
		external set isPlaying(bool v);external 

         Audio load(String file );external 
         void play();external 
         void pause();external 
         void stop();external 
         void connect();external 
         void disconnect();external 
         void setFilter(dynamic value );external 
         dynamic getFilter();external 
         void setPlaybackRate(num value );external 
         num getPlaybackRate();external 

         void setLoop(bool value );external 
         bool getLoop();external 
         void setRefDistance(num value );external 
         num getRefDistance();external 
         void setRolloffFactor(num value );external 
         num getRolloffFactor();external 
         void setVolume(num value );external 
         num getVolume();external 
...
class AudioListener  extends Object3D  {
	external factory AudioListener ();
		...
		external set type(String v);
         external AudioContext get context;
		external set context(AudioContext v);external 
...
@JS()
class Curve  {
	external factory Curve<T();

        
         

		external dynamic getPoint(num t );external 

        
         Vector getPointAt(num u );external 

        
         List<Vector> getPoints(num divisions );external 

        
         List<Vector> getSpacedPoints(num divisions );external 

        
         num getLength();external 

        
         List<num> getLengths(num divisions );external 

        
         void updateArcLengths();external 

        
         num getUtoTmapping(num u , num distance );external 

        
         dynamic getTangent(num t );external 

        
         dynamic getTangentAt(num u );

         external static Function create(Function constructorFunc , Function getPointFunc );
...
class CurveUtils    {
	external factory CurveUtils();
		...
		external num tangentQuadraticBezier(num t , num p0 , num p1 , num p2 );external 
         num tangentCubicBezier(num t , num p0 , num p1 , num p2 , num p3 );external 
         num tangentSpline(num t , num p0 , num p1 , num p2 , num p3 );external 
         num interpolate(num p0 , num p1 , num p2 , num p3 , num t );
...
class CurvePath extends Curve<T>  {
	external factory CurvePath ();
		...
		external set autoClose(bool v);external 

         void add(Curve<T> curve );external 
         bool checkConnection();external 
         void closePath();external 
         dynamic getPoint(num t );external 
         num getLength();external 
         List<num> getCurveLengths();external 
         Geometry createPointsGeometry(num divisions );external 
         Geometry createSpacedPointsGeometry(num divisions );external 
         Geometry createGeometry(List<Vector> points );
...
class Path  extends CurvePath<Vector2>  {
	external factory Path ([ List<Vector2> points ]);
		...
		external set actions(List<PathAction> v);external 

         void fromPoints(List<Vector2> vectors );external 
         void moveTo(num x , num y );external 
         void lineTo(num x , num y );external 
         void quadraticCurveTo(num aCPx , num aCPy , num aX , num aY );external 
         void bezierCurveTo(num aCP1x , num aCP1y , num aCP2x , num aCP2y , num aX , num aY );external 
         void splineThru(List<Vector2> pts );external 
         void arc(num aX , num aY , num aRadius , num aStartAngle , num aEndAngle , bool aClockwise );external 
         void absarc(num aX , num aY , num aRadius , num aStartAngle , num aEndAngle , bool aClockwise );external 
         void ellipse(num aX , num aY , num xRadius , num yRadius , num aStartAngle , num aEndAngle , bool aClockwise , num aRotation );external 
         void absellipse(num aX , num aY , num xRadius , num yRadius , num aStartAngle , num aEndAngle , bool aClockwise , num aRotation );external 
         List<Vector2> getSpacedPoints(num divisions , bool closedPath );external 
         List<Vector2> getPoints(num divisions , bool closedPath );external 
         List<Shape> toShapes();
...
class Shape  extends Path  {
	external factory Shape ([ List<Vector2> points ]);
		...
		external set holes(List<Path> v);external 

         ExtrudeGeometry extrude(dynamic options );external 
         ShapeGeometry makeGeometry(dynamic options );external 
         List<List<Vector2>> getPointsHoles(num divisions );external 
         dynamic extractAllPoints(num points);external 
         List<Vector2> extractPoints(num divisions );
...
class ArcCurve  extends EllipseCurve  {
	external factory ArcCurve ([ num aX, num aY, num aRadius, num aStartAngle, num aEndAngle, bool  aClockwise ]);
...
class CubicBezierCurve  extends Curve<Vector2>  {
	external factory CubicBezierCurve ([ Vector2 v0, Vector2 v1, Vector2 v2, Vector2 v3 ]);
...
class CubicBezierCurve3  extends Curve<Vector3>  {
	external factory CubicBezierCurve3 ([ Vector3 v0, Vector3 v1, Vector3 v2, Vector3 v3 ]);
...
class EllipseCurve  extends Curve<Vector2>  {
	external factory EllipseCurve ([ num aX, num aY, num xRadius, num yRadius, num aStartAngle, num aEndAngle, bool aClockwise, num aRotation ]);
...
class BoxGeometry  extends Geometry  {
	external factory BoxGeometry ([ num width, num height, num depth, num widthSegments, num heightSegments, num depthSegments ]);
		...
		external set parameters(dynamic v);external 
...
class CircleBufferGeometry  extends Geometry  {
	external factory CircleBufferGeometry ([ num radius, num segments, num thetaStart, num thetaLength ]);
...
class CircleGeometry  extends Geometry  {
	external factory CircleGeometry ([ num radius, num segments, num thetaStart, num thetaLength ]);
...
class CylinderGeometry  extends Geometry  {
	external factory CylinderGeometry ([ num radiusTop, num radiusBottom, num height, num radiusSegments, num heightSegments, bool openEnded, num thetaStart, num thetaLength ]);
...
class ExtrudeGeometry  extends Geometry  {
	external factory ExtrudeGeometry ([ List<Shape> shapes, dynamic options ]);
		...
		external static dynamic get WorldUVGenerator;external 

         void addShapeList(List<Shape> shapes , dynamic options );external 
         void addShape(Shape shape , dynamic options );
...
class LatheGeometry  extends Geometry  {
	external factory LatheGeometry ([ List<Vector3> points, num segments, num phiStart, num phiLength ]);
...
class ParametricGeometry  extends Geometry  {
	external factory ParametricGeometry ([ Func2<num,num,Vector3> func, num slices, num stacks ]);
...
class PlaneBufferGeometry  extends BufferGeometry  {
	external factory PlaneBufferGeometry ([ num width, num height, num widthSegments, num heightSegments ]);
...
class PlaneGeometry  extends Geometry  {
	external factory PlaneGeometry ([ num width, num height, num widthSegments, num heightSegments ]);
...
class PolyhedronGeometry  extends Geometry  {
	external factory PolyhedronGeometry ([ List<Vector3> vertices, List<Face3> faces, num radius, num detail ]);
...
class RingGeometry  extends Geometry  {
	external factory RingGeometry ([ num innerRadius, num outerRadius, num thetaSegments, num phiSegments, num thetaStart, num thetaLength ]);
...
class ShapeGeometry  extends Geometry  {
	external factory ShapeGeometry ([ List<Shape> shapes, dynamic options ]);
		...
		external ShapeGeometry addShapeList(List<Shape> shapes , dynamic options );external 
         void addShape(Shape shape , dynamic options );
...
class SphereBufferGeometry  extends BufferGeometry  {
	external factory SphereBufferGeometry ([ num radius, num widthSegments, num heightSegments, num phiStart, num phiLength, num thetaStart, num thetaLength ]);
...
class SphereGeometry  extends Geometry  {
	external factory SphereGeometry ([ num radius, num widthSegments, num heightSegments, num phiStart, num phiLength, num thetaStart, num thetaLength ]);
...
class TorusGeometry  extends Geometry  {
	external factory TorusGeometry ([ num radius, num tube, num radialSegments, num tubularSegments, num arc ]);
...
class TorusKnotGeometry  extends Geometry  {
	external factory TorusKnotGeometry ([ num radius, num tube, num radialSegments, num tubularSegments, num p, num q, num heightScale ]);
...
class TubeGeometry  extends Geometry  {
	external factory TubeGeometry ([ Path path, num segments, num radius, num radiusSegments, bool closed, Func1<num,num> taper ]);
		...
		external set binormals(List<Vector3> v);
         ...
         external static void FrenetFrames(Path path , num segments , bool closed );external 
...
class ArrowHelper  extends Object3D  {
	external factory ArrowHelper ([ Vector3 dir, Vector3 origin, num length, num hex, num headLength, num headWidth ]);
		...
		external set cone(Mesh v);external 

         void setDirection(Vector3 dir );external 
         void setLength(num length ,  num headLength , num headWidth );external 
         void setColor(num hex );
...
class BoundingBoxHelper  extends Mesh  {
	external factory BoundingBoxHelper ([ Object3D object, num hex ]);
		...
		external set box(Box3 v);external 
...
class CameraHelper  extends LineSegments  {
	external factory CameraHelper ([ Camera camera ]);
		...
		external Camera get camera;
		external set camera(Camera v);
/*         pointMap # [id: String]: List<num>; # ; */external 
...
class DirectionalLightHelper  extends Object3D  {
	external factory DirectionalLightHelper ([ Light light, num size ]);
		...
		external set targetLine(Line v);external 
...
class FaceNormalsHelper  extends LineSegments  {
	external factory FaceNormalsHelper ([ Object3D object, num size, num hex, num linewidth ]);
		...
		external set object(Object3D v);
         external num get size;
		external set size(num v);external 
...
class GridHelper  extends LineSegments  {
	external factory GridHelper ([ num size, num step ]);
		...
		external set color2(Color v);external 
...
class HemisphereLightHelper  extends Object3D  {
	external factory HemisphereLightHelper ([ Light light, num sphereSize ]);
		...
		external set lightSphere(Mesh v);external 
...
class PointLightHelper  extends Object3D  {
	external factory PointLightHelper ([ Light light, num sphereSize ]);
		...
		external Light get light;
		external set light(Light v);external 
...
class SkeletonHelper  extends LineSegments  {
	external factory SkeletonHelper ([ Object3D bone ]);
		...
		external set root(Object3D v);external 

         List<Bone> getBoneList(Object3D object );external 
         void update();
...
class SpotLightHelper  extends Object3D  {
	external factory SpotLightHelper ([ Light light, num sphereSize, num arrowLength ]);
...
class VertexNormalsHelper  extends LineSegments  {
	external factory VertexNormalsHelper ([ Object3D object, num size, num hex, num linewidth ]);
...
class ImmediateRenderObject  extends Object3D  {
	external factory ImmediateRenderObject ([ Material material ]);
		...
		external Material get material;
		external set material(Material v);external 
         void render(Function renderCallback );
...
class MorphBlendMesh  extends Mesh  {
	external factory MorphBlendMesh ([ Geometry geometry, Material material ]);
		...
		/*         animationsMap # name: String; # ; */
         external List<MorphBlendMeshAnimation> get animationsList;
		external set animationsList(List<MorphBlendMeshAnimation> v);external 

         void createAnimation(String name , num start , num end , num fps );external 
         void autoCreateAnimations(num fps );external 
         void setAnimationDirectionForward(String name );external 
         void setAnimationDirectionBackward(String name );external 
         void setAnimationFPS(String name , num fps );external 
         void setAnimationDuration(String name , num duration );external 
         void setAnimationWeight(String name , num weight );external 
         void setAnimationTime(String name , num time );external 
         num getAnimationTime(String name );external 
         num getAnimationDuration(String name );external 
         void playAnimation(String name );external 
         void stopAnimation(String name );external 
